# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 11:29:05 2020
...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/dev_meta.json')
    parser.add_argument('--test_meta_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/test_meta.json')
    parser.add_argument('--word2idx_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/word2idx.json')
    parser.add_argument('--char2idx_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/char2idx.json')
    parser.add_argument('--answer_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/answer.json')
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/train.npz')
    parser.add_argument('--dev_record_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/dev.npz')
    parser.add_argument('--test_record_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/test.npz')
    parser.add_argument('--word_emb_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/word_emb.json')
    parser.add_argument('--char_emb_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/char_emb.json')
    parser.add_argument('--train_eval_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/train_eval.json')
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/dev_eval.json')
    parser.add_argument('--test_eval_file',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/data/test_eval.json')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--save_dir',
                        type=str,
                        default='/labs/gevaertlab/data/gnervo/squad/save/',
