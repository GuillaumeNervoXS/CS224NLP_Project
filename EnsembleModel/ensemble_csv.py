...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 19:05:33 2020
...
qanet2='./models_for_analysis/qanet(2).csv'
bidaf_baseline='./models_for_analysis/bidaf_baseline.csv'
bidaf_with_char='./models_for_analysis/bidaf_with_char.csv'
bidaf_fusion='./models_for_analysis/bidaf_fusion.csv'
qanet_dif_output='./models_for_analysis/qanet_diff_output.csv'
qanet_dif_output_2='./models_for_analysis/qanet_diff_output_2.csv'
qanet_unshared_weights='./models_for_analysis/qanet_unshared_weights.csv'
qanet1='./models_for_analysis/qanet(1).csv'
qanet3='./models_for_analysis/qanet(3).csv'
qanet_unshared_weights_2='./models_for_analysis/qanet_unshared_weights_2.csv'
average='./models_for_analysis/average_submission.csv'
...
def write_csv(sub_dict):
    with open('./save/dev_submission.csv', 'w', newline='', encoding='utf-8') as csv_fh:
        csv_writer = csv.writer(csv_fh, delimiter=',')
        csv_writer.writerow(['Id', 'Predicted'])
        for uuid in sorted(sub_dict):
            csv_writer.writerow([uuid, sub_dict[uuid]])

dic_qanet2=preprocess_results(qanet2)
dic_baseline=preprocess_results(bidaf_baseline)
dic_with_char=preprocess_results(bidaf_with_char)
dic_fusion=preprocess_results(bidaf_fusion)
dic_output=preprocess_results(qanet_dif_output)
#dic_output_2=preprocess_results(qanet_dif_output_2)
dic_weights=preprocess_results(qanet_unshared_weights)
dic_weights_2=preprocess_results(qanet_unshared_weights_2)
dic_qanet1=preprocess_results(qanet1)
dic_qanet3=preprocess_results(qanet3)

dic_average=preprocess_results(average)
